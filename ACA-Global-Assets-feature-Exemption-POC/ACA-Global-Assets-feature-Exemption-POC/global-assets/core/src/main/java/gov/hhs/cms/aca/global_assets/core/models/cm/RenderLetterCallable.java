 ...
 *
 */
public class RenderLetterCallable implements Callable<Document> {
	
	final private String letterId;
	final private String letterData;
	
	private static final Logger log = LoggerFactory.getLogger(RenderLetterCallable.class);
	
	public RenderLetterCallable(String letterId, String letterData, ResourceResolver resolver){
	...
	@Override
	public Document call() throws LetterGenerationException {
		...
		return letterService.renderCmLetter(this.letterId, this.letterData, null);
	}
}