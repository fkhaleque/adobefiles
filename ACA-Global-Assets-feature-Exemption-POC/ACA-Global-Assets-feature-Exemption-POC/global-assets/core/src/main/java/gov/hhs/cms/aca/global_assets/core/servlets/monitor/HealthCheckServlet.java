 ...
 */
package gov.hhs.cms.aca.global_assets.core.servlets.monitor;
...
label = "ACA Global Assets - HealthCheck Servlet", description = "ACA Global Assets - HealthCheck Servlet class")
public class HealthCheckServlet extends SlingSafeMethodsServlet {
	...
	protected static final String packageName = "acaglobal";
	...
	protected void doGet(final SlingHttpServletRequest request,
		...
		final JSONObject tests = new JSONObject();
